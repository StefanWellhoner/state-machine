...
const Robot: FC<RobotProps> = ({ machine }) => {
  const [machineState, setMachineState] = useState<RobotStates>(
    () => machine.state,
  );
  ...
  return (
    <div className="light-container">
      ...
      <div
        className={machineState === "yellow" ? "light yellow" : "light off"}
      ></div>
      <div
        className={machineState === "green" ? "light green" : "light off"}
      ></div>
    </div>
  );
};
